...
{
    public class AxisPCB上料工站Tray : AxisTrayLiftBase
    {
        private AxisPCB上料工站Tray()
        ...
        public static readonly AxisPCB上料工站Tray Cur = new AxisPCB上料工站Tray();
        public static AxisPCB上料工站Tray CreateInstrance()
        {
            return Cur;
        }
